# Баттлтест GEO-аудита — 5 сайтов РФ (16.09.2026)
...
- **Бенчмарк «score 0-100 + grade за 10 минут» — выполнен.** 5 сайтов оценены за 8 минут на прогон, score считается по заявленной формуле.
- **92 правила валидируются на реальных сайтах** — каждый gap выше = конкретное правило из lint-набора сработало.
- **A-F grading работает**: разброс 42 (D) → 87 (A−) различим и интерпретируем.
